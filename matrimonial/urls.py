...
from info.views import login_success
...
urlpatterns = [
    ...
    path('accounts/password_reset/',auth_views.PasswordResetView.as_view(template_name='password_reset_form.html',success_url='/accounts/password_reset/done/'),name='password_reset'),
